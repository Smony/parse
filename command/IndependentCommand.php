...
class IndependentCommand extends Command
{
    protected static $defaultName = 'app:independent-politics';

    public $url = "https://www.independent.com/wp-json/wp/v2/posts?categories=1813&per_page=10";
